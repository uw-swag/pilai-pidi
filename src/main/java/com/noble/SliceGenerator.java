    ...
    private void analyzeDecl(Node decl) {
        ...
        if (init != null) {
            ...
            if (init_node != null) {
                ...
                for (Node expr : init_expr) {
                    if (analyzeExprAndUpdateDVar(namePos, expr)) return;
                }
            }
        }
        ...
        if (typeName != null && !typeName.isEmpty() && init == null) {
            ...
            if (!local_variables.containsKey(cfunction_name) && !global_variables.containsKey(cfunction_name)) {
                ...
                SliceProfile cfunction_profile = new SliceProfile(file_name, current_function_name, cfunction_name, null, cfunction_pos, current_function_node);
        ...
        for (Node arg_expr : argument_list) {
            ...
            for (Node expr : asList(argument_c_node.getChildNodes())) {
                ...
                if (local_variables.containsKey(var_name)) {
                    ...
                    if (!cfunction_identifier.equals(""))
...
//        String rhs_expr_pos = rhs_expr_name_pos_pair.getPos();
        ...
        if (lhs_expr_var_name == null || rhs_expr_var_name == null || lhs_expr_var_name.equals(rhs_expr_var_name))
            return;
