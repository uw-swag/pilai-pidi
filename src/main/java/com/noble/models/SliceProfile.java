...
public class SliceProfile {
    ...
    public SliceProfile(String file_name, String function_name, String var_name, String type_name,
                        String defined_position, ArrayList<SliceVariableAccess> used_positions,
                        NamePos[] dependent_vars, String[] pointers, Hashtable<String, cFunction> cfunctions,
                        Node function_node) {
    ...
    public SliceProfile(String file_name, String current_function_name, String name, String type,
                        String pos, Node current_function_node) {
        this.file_name = file_name;
